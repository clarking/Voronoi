...
namespace Voronoi {
	...
	treeNode<BeachSection> *VoronoiGenerator::addBeachSection(Site *site) {
		double x = site->p.x;
	...
	void VoronoiGenerator::removeBeachSection(treeNode<BeachSection> *section) {
...
// given a particular sweep line height
	double VoronoiGenerator::leftBreakpoint(treeNode<BeachSection> *section, double directrix) {
...
// given a particular sweep line height
	double VoronoiGenerator::rightBreakpoint(treeNode<BeachSection> *section, double directrix) {
